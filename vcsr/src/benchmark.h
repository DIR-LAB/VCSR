...
typedef NodeWeight<NodeID, WeightT, TimestampT> WNode;
...
typedef BuilderBase<NodeID, NodeID, WeightT, TimestampT> Builder;
typedef BuilderBase<NodeID, WNode, WeightT, TimestampT> WeightedBuilder;
